...
const QuestionsItems = ({ quest, ans }) => {
  ...
  return (
    <div className="flex flex-col  w-3/3 md:w-3/4 mb-6 ">
      ...
      >
        <div className="flex-1 text-white text-xs md:text-lg lg:text-xl xl:text-xl text-justify">{quest}</div>
      ...
      >
        <div className="text-base text-white leading-relaxed text-justify">{ans}</div>
      </div>
    </div>
  );
};
